...
## First, lets extract the  relevant metadata from above ("metadata.filtered" object) to use in our phylogenetic trees (using the dplyr package). We need to extract the hosts and clonal complexes for plotting.
